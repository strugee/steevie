...
apache::vhost { 'pages.strugee.net_plaintext':
  servername      => 'pages.strugee.net',
  ip              => '216.160.72.225',
  port            => '80',
  docroot         => '/var/empty',
  redirect_status => 'permanent',
  redirect_dest	  => 'https://pages.strugee.net/',
}

apache::vhost { 'pages.strugee.net_ssl':
  servername      => 'pages.strugee.net',
  ip              => '216.160.72.225',
  port            => '443',
  docroot         => '/var/empty',
  ssl_proxyengine    => true,
  proxy_pass         => [
    { 'path' => '/', 'url' => 'http://localhost:53841/',
      'reverse_urls' => 'http://localhost:53841/' },
  ],
  proxy_preserve_host => true,
  ssl             => true,
  ssl_cert        => '/etc/letsencrypt/live/strugee.net/cert.pem',
...
apache::vhost { 'owntracks.strugee.net_plaintext':
  servername      => 'owntracks.strugee.net',
  ip              => '216.160.72.225',
  port            => '80',
  docroot         => '/var/empty',
  redirect_status => 'permanent',
  redirect_dest   => 'https://owntracks.strugee.net/',
}

apache::vhost { 'owntracks.strugee.net_ssl':
  servername      => 'owntracks.strugee.net',
  ip              => '216.160.72.225',
  port            => '443',
  docroot         => '/var/empty',
...
apache::vhost { 'ssh.strugee.net_ssl':
  ...
  proxy_pass         => [
    { 'path' => '/ws', 'url' => 'ws://localhost:10443/ws',
      'reverse_urls' => 'http://localhost:10443/ws' },
