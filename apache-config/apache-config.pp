...
apache::vhost { 'strugee.net ssl':
  ...
  ssl           => true,
  ssl_cert      => '/etc/letsencrypt/live/strugee.net-0001/cert.pem',
  ssl_key       => '/etc/letsencrypt/live/strugee.net-0001/privkey.pem',
  ssl_chain     => '/etc/letsencrypt/live/strugee.net-0001/chain.pem',
  ssl_cipher    => 'HIGH:MEDIUM:!aNULL:!MD5:!RC4',
  block		=> 'scm',
  ssl_protocol  => 'all -SSLv2 -SSLv3',
  headers       => 'Set Strict-Transport-Security: "max-age=31536000; includeSubDomains; preload"',
...
apache::vhost { 'cloud.strugee.net ssl':
  ...
  redirect_dest    => ['https://cloud.strugee.net/remote.php/webdav/', 'https://cloud.strugee.net/remote.php/caldav/', 'https://cloud.strugee.net/remote.php/carddav/'],
  ssl 		   => true,
  ssl_cert	   => '/etc/letsencrypt/live/cloud.strugee.net/cert.pem',
  ssl_key	   => '/etc/letsencrypt/live/cloud.strugee.net/privkey.pem',
  ssl_chain        => '/etc/letsencrypt/live/cloud.strugee.net/chain.pem',
  ssl_cipher       => 'HIGH:MEDIUM:!aNULL:!MD5:!RC4',
  block		   => 'scm',
  override	   => 'all',
  ssl_protocol     => 'all -SSLv2 -SSLv3',
...
apache::vhost { 'bugzilla.strugee.net ssl':
  ...
  docroot_group      => 'www-data',
  ssl                => true,
  ssl_cert           => '/etc/letsencrypt/live/bugzilla.strugee.net/cert.pem',
  ssl_key            => '/etc/letsencrypt/live/bugzilla.strugee.net/privkey.pem',
  ssl_chain          => '/etc/letsencrypt/live/bugzilla.strugee.net/chain.pem',
  ssl_cipher         => 'HIGH:MEDIUM:!aNULL:!MD5:!RC4',
  block              => 'scm',
  ssl_protocol       => 'all -SSLv2 -SSLv3',
